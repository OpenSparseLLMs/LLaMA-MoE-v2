...
# reserved spot auto
# NOTE: This should be run on single GPU as the clustering is time-consuming, which may cause the NCCL timeout error!!!!!!!!!!!!!!!!
...

{
  ...
  echo "Total number of samples: $((${per_device_train_batch_size} * ${max_steps} * ${model_max_length}))"
