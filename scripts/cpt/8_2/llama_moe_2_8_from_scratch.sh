...
#SBATCH --job-name=llama_moe_2_8_from_scratch
#SBATCH --output=/mnt/petrelfs/share_data/quxiaoye/runs/llama_moe_2_8_from_scratch/%x-%j.log
#SBATCH --error=/mnt/petrelfs/share_data/quxiaoye/runs/llama_moe_2_8_from_scratch/%x-%j.log
...

{
    ...
    pretrained_model=/mnt/petrelfs/zhutong/smoe/resources/random_8_2
