...
#SBATCH -w SH-IDCA1404-10-140-54-[34,66,111,123]
...

{
    ...
    dataset_dir_or_path="/mnt/petrelfs/huxuyang/smoe/resources/datasets_sft/data.jsonl"
    ...
    model_name_or_path="/mnt/petrelfs/share_data/quxiaoye/llama_moe_v2/split-gradient-max-ShareFalse-1Residual-7MoE-Top1" # residual version
